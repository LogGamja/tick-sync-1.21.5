...
public class TickSyncSetting extends Screen {
    ...
    protected void init() {
        ...
        toggleIndices[2] = cfg.useUnstableEnvOption ? 1 : 0;
    ...
    void onButtonClick(int button, int index) {
        ...
        if (button == 0) {
            ...
            cfg.useUnstableEnvOption = (index != 0);
        }
        else if (button == 3) {
